...
\medskip\noindent\textit{Proof of \ref{thm:moon-orginal} modulo \ref{thm:moon}.}
...
\medskip\noindent\textit{Proof of \ref{thm:moon}.}
...
A very transparent proofs was given by Robert Osserman \cite{osserman}; his paper contains a short account of the history of the theorem.
...
\bibitem{aamand-abrahamsen-thoru} A. Aamand, M. Abrahamsen, and M. Thorup. Disks in curves of
bounded convex curvature. \textit{Amer. Math. Monthly} \textbf{127.7} (2020), 579--593.

\bibitem{bing} R. H. Bing. 
Some aspects of the topology of 3-manifolds related to the Poincaré conjecture. 
\textit{Lectures on modern mathematics, Vol. II.} 1964, 93--128.

\bibitem{ghys-tabachnikov-timorin}
É. Ghys, S. Tabachnikov, and V. Timorin. 
Osculating curves: around the Tait--Kneser theorem.
\textit{Math. Intelligencer} \textbf{35.1} (2013), 61--66.


\bibitem{lagunov-2}\begin{otherlanguage}{russian}
В. Н. Лагунов. О наибольшем шаре, вложенном в замкнутую поверхность,
II. \textit{Сибирский математический журнал}\end{otherlanguage}
\ \textbf{2.6} (1961), 874--883.


\bibitem{lagunov-fet}\begin{otherlanguage}{russian}
В. Н. Лагунов и А. И. Фет. Экстремальные задачи для поверхностей за-
данного топологического типа II. \textit{Сибирский математический журнал}\end{otherlanguage}
\ \textbf{6}
(1965), 1026--1036.
...
\bibitem{pankrashkin} K. Pankrashkin. An inequality for the maximum curvature through a geometric flow. 
\textit{Arch. Math. (Basel)} \textbf{105.3} (2015), 297--300.

\bibitem{panov-petrunin} D. Panov and A. Petrunin. Ramification conjecture and Hirzebruch’s property
of line arrangements. \textit{Compos. Math.} \textbf{152.12} (2016), 2443--2460.

\bibitem{pestov-ionin}\begin{otherlanguage}{russian}
Г. Г. Пестов и Ионин В. К. О наибольшем круге, вложенном в замкнутую
кривую. \textit{Доклады АН СССР}\end{otherlanguage}\  \textbf{127} (1959), 1170--1172.

\bibitem{petrunin-2020}
A. Petrunin. \textit{PIGTIKAL (puzzles in geometry that I know and love).} 
2020.

\bibitem{petrunin-zamora} A. Petrunin and S. Zamora Barrera. \textit{What is differential geometry: curves and
surfaces.} 2020.
